...
def pregunta_10():
    ...
    la columna _c2 organizados alfabeticamente para el archivo `tbl0.tsv`.
...
def pregunta_11():
    ...
    39   39    a,d,f
    """
    return pd.DataFrame(tbl1.groupby("_c0")["_c4"].apply(lambda x: ",".join(x.sort_values())).reset_index())
...
def pregunta_12():
    ...
    return pd.DataFrame(tbl2.groupby("_c0")["_c5"].apply(lambda x: ",".join(x.sort_values())).reset_index())
